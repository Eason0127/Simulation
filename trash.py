...
# --- Read image ---
object = load_and_normalize_image('/Users/wangmusi/Documents/GitHub/Simulation/test.png')
...
numPixels_image = 748  # The dimension of the image
...
rec_field, rms_errors, ssim_errors = IPR(am_hologram, z2, 50, 1.5e-20, sensor_pixel_sizes[0], W, H, numPixels_image, am_object_field)
