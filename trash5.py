...
image1 = load_and_normalize_image("/Users/wangmusi/Desktop/hdrrec1.png")
image2 = load_and_normalize_image("/Users/wangmusi/Desktop/filterchange.png")
diff = image2 - image1
print(np.max(diff))
plot_image2(diff,"diff")
